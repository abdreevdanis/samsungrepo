...
Essential предназначен для пользователей, которым нужно хранить знания в виде связанных markdown-заметок и быстро получать ответы ИИ на основе собственного архива — без передачи всего vault в облако. Приложение объединяет редактор заметок, wiki-ссылки, граф связей, семантический поиск и гибридный ИИ-стек (офлайн на устройстве или через REST API).
